...
from ...models.web_update_order_query_order import WebUpdateOrderQueryOrder
from ...types import Response


def _get_kwargs(
    *,
    body: WebUpdateOrderQueryOrder,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Updates the query order.

     Updates the query order with the specified ordering.
