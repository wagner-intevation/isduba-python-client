...
from ...models.put_aggregators_id_body import PutAggregatorsIdBody
...
def sync_detailed(
    ...
    *,
    ...
    """Updates aggregator configuration.

     Updates the aggregator configuration.
