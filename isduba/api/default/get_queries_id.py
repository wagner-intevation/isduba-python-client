...
) -> Optional[Union[Any, ModelsError, ModelsStoredQuery]]:
    if response.status_code == 200:
        response_200 = ModelsStoredQuery.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, ModelsError, ModelsStoredQuery]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Updates a stored query.
     ...
     Updates a feed with the specified configuration.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ModelsError, ModelsStoredQuery]
    """
