...
) -> Optional[Union[Any, ModelsError, list["ModelsSuccess"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSuccess.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, ModelsError, list["ModelsSuccess"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ModelsError, list['ModelsSuccess']]
    """
