...
from ...models.post_tempdocuments_body import PostTempdocumentsBody
from ...types import Response


def _get_kwargs(
    *,
    body: PostTempdocumentsBody,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ModelsID.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Uploads a temporary document.

     Uploads a temporary document, that can be used to create diff views.
