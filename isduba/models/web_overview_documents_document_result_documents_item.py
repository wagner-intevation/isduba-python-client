...
class WebOverviewDocumentsDocumentResultDocumentsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = WebOverviewDocumentsDocumentResultDocumentsItemAdditionalProperty.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        web_overview_documents_document_result_documents_item.additional_properties = additional_properties
